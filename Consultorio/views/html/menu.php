<div class='sidebar pe-4 pb-3'>
    <nav class='navbar bg-darki navbar-light'>
        ...
        <div class='navbar-nav w-100'>
            ...
            <a href='paciente.php' class='nav-item nav-link'><i class='fa fa-tachometer-alt me-2'></i>Paciente</a>


            <a href='odontologo.php' class='nav-item nav-link'><i class='fa fa-th me-2'></i>Odontologo</a>
            ...
            <a href='historial.php' class='nav-item nav-link'><i class='fa fa-th me-2'></i>Historial Medico</a>
